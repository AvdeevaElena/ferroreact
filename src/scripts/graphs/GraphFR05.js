...
import { graphOptionsFR05 }                                from './GraphOptionsFR05'
...
// Graph
export class GraphFR05 extends React.Component {
  ...
  requestData(dataToRequest){
   ...
   console.log ('RequestGraphData',RequestGraphData(kiln_constants_ru.ФР05, 'http://172.16.20.75:8060/?graph=' + kiln_constants_en.ФР05 + '&program_number=' + dataToRequest + '&year=' + new Date().getFullYear(), AuthStr));
    

    RequestGraphData(kiln_constants_ru.ФР05, 'http://172.16.20.75:8060/?graph=' + kiln_constants_en.ФР05 + '&program_number=' + dataToRequest + '&year=' + new Date().getFullYear(), AuthStr).then(resultArrayTablePresets=>{
     
      console.log ("resultArrayTablePresets", resultArrayTablePresets); 
  ...
  render() {
    var displayParameter =buttonSelectionPreset(this.props.graph_mode_selection, kiln_constants_ru.ФР05);
    return (
...
export default connect(mapStateToProps)(GraphFR05);