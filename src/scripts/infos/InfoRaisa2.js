...
/*
 Detailed information on kiln Raisa2
...
export class InfoRaisa2 extends React.Component{
  ...
  requestData(){
    ...
    RequestTimelineData(kiln_constants_ru.Раиса2, 'http://172.16.20.75:8060/?generaltimeline=' + kiln_constants_en.Раиса2, AuthStr)
