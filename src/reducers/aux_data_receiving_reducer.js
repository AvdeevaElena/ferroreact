...
[{
  kiln:                 Наименование печи 
  number:               Номер для отображения графика (добавляется при входе, обновляется при открытии gtml и при выборе в таймлайне).
  two_tables_number:    Номер для отображения двух таблиц (добавляется только! при выборе данных в таблице). Его наличие служит признаком для отображения двух таблиц, иначе график.
}]
*/
